<template>
  <navbar></navbar>
  <button class="menu-button" :style="buttonStyle" :class="{ open: isMenuOpen, disabled: isMenuDisabled }" :disabled="isMenuDisabled" @click="toggleMenu">☰</button>
...
<script setup>
  ...
  var isMenuDisabled = ref(token.value == null);

  watch(token,(newValue) => {
    isMenuDisabled.value = (newValue === null);
  });
